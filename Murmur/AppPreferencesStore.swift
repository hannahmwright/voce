...
actor AppPreferencesStore {
    ...
    private static let logger = Logger(subsystem: "io.murmurapp.murmur", category: "AppPreferencesStore")
    ...
    private static func migrateIfNeeded() {
        ...
        let newDir = appSupport.appendingPathComponent("Murmur", isDirectory: true)
