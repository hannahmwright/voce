import Foundation
import Testing
@testable import MurmurBenchmarkCore
...
func pipelineRunComputesExpectedSummaries() async {
    ...
    let rawOutput = RawEngineOutput(
        ...
        samples: [
            .init(
                ...
                audioPath: "audio.wav",
                referenceText: "Steno testing",
                hypothesisText: "um murmurh testing",
                languageHint: "en",
                status: .success,
                errorMessage: nil,
                elapsedMS: 100,
    ...
    let lexicon = PersonalLexicon(entries: [.init(term: "murmurh", preferred: "Murmur", scope: .global)])
