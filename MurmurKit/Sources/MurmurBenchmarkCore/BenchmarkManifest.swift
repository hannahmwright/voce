...
public struct BenchmarkManifest: Sendable, Codable {
    ...
    public init(
        schemaVersion: String = "murmur-benchmark-manifest/v1",
        benchmarkName: String = "Murmur Benchmark",
...
public struct NormalizationPolicy: Sendable, Codable {
    ...
    public init(
        version: String = "murmur-normalization-v1",
        lowercase: Bool = true,
...
public struct BenchmarkLexiconFile: Sendable, Codable {
    ...
    public init(
        schemaVersion: String = "murmur-lexicon-v1",
...
public struct BenchmarkLexiconEntry: Sendable, Codable {
    ...
    public var murmurEntry: LexiconEntry {
...
public struct BenchmarkRuntimeMetadata: Sendable, Codable {
    ...
    public init(
        ...
        toolVersion: String = "murmur-benchmark-cli/v1"
    ) {
...
public struct RawEngineOutput: Sendable, Codable {
    ...
    public init(
        schemaVersion: String = "murmur-raw-engine-results/v1",
...
public struct PipelineOutput: Sendable, Codable {
    ...
    public init(
        schemaVersion: String = "murmur-pipeline-results/v1",
        benchmarkName: String,
        runtime: BenchmarkRuntimeMetadata = BenchmarkRuntimeMetadata(),
...
public struct MacSanityChecklist: Sendable, Codable {
    ...
    public init(
        schemaVersion: String = "murmur-mac-sanity/v1",
        generatedAt: Date = Date(),
